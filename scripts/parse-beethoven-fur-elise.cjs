...
const MIDI_PATH = path.resolve(__dirname, "../public/midi/elise.mid");
const OUTPUT_PATH = path.resolve(
  __dirname,
  "../src/content/pieces/beethovenFurElise.ts",
);
const EXPECTED_SHA256 =
  "a1481bdafe94d33e0de8934c97aec45534c908bc797bae7293f626074aec2e07";
...
if (selectedNoteOns.length !== 1041)
...
if (
  rawEvents.length !== 785 ||
  collisions !== 0 ||
  velocities.size !== 52 ||
  maxSimultaneity !== 6 ||
  JSON.stringify(rawEvents[0]) !== JSON.stringify([867, [[76, 36, 220]]]) ||
